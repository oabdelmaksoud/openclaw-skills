...
|--------|----------|--------------|
| **plugin-dev** | Building OpenClaw plugins | Skills for creating skills, hooks, commands, agents |
...
- User wants to install OpenClaw automations from Anthropic's official repository or another shared marketplace
